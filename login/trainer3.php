...
<link rel="stylesheet" href="../sweetalert2.min.css">
						...
						<ul>
							...
							<li  class="active has-dropdown">
								...
								<ul class="dropdown">
									...
									<li class="active"><a href="trainer3.php">Pilin Anice</a></li>
	...
	<!-- header -->
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(../images/trainer-3-h.jpg);" data-stellar-background-ratio="0.5">
