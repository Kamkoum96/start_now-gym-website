...
<link rel="stylesheet" href="../sweetalert2.min.css">
						...
						<ul>
							...
							<li  class="active has-dropdown">
								...
								<ul class="dropdown">
									...
									<li class="active"><a href="trainer4.php">Bret Contreras</a></li>
								</ul>
							</li>
	...
	<!-- header -->
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(../images/trainer-4-h.png);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-8 col-sm-8 animate-box">
					...
					<div class="animate-box">
						...
						<div class="desc text-center">
								...
								<li><a href="https://twitter.com/bretcontreras"><i class="icon-twitter"></i></a></li>
								<li><a href="https://www.facebook.com/bretcontreras"><i class="icon-facebook"></i></a></li>
								<li><a href="https://www.instagram.com/bretcontreras1/"><i class="icon-instagram"></i></a></li>
							</ul>
						</div>
					</div>
