...
<link rel="stylesheet" href="../sweetalert2.min.css">
						...
						<ul>
							...
							<li  class="active has-dropdown">
								...
								<ul class="dropdown">
									...
									<li class="active"><a href="yoga.php">Yoga</a></li>
	...
	<!-- header -->
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(../images/yoga2.jpg);" data-stellar-background-ratio="0.5">
					...
					<div class="cover">
						<div class="card">
							...
							<svg width="100%" viewBox="0 0 700 500">
								...
								<image clip-path="url(#clip-path)" xlink:href="../images/yoga4.jpg" width="100%"
					...
					<div class="cover">
						<div class="card">
							...
							<svg width="100%" viewBox="0 0 700 500">
								...
								<!-- xlink:href for modern browsers, src for IE8- -->
								<image clip-path="url(#clip-path)" xlink:href="../images/yoga5.jpg" width="100%"
									   height="465" class="svg__image"></image>
							</svg>
						</div>
					</div>
