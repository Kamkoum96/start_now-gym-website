...
<link rel="stylesheet" href="../sweetalert2.min.css">
						...
						<ul>
							...
							<li  class="active has-dropdown">
								...
								<ul class="dropdown">
									...
									<li class="active"><a href="Cadio.php">Cardio</a></li>
								</ul>
							</li>
	...
	<!-- header -->
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(../images/cardio1.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>If I do cardio I'll disappear</h1>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-3 text-center animate-box">
					<div class="services">
						...
						<h3>Runnig</h3>
						<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius</p>
						<p><a href="running.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="cover">
						<div class="card">
							...
							<svg width="100%" viewBox="0 0 700 500">
								...
								<image clip-path="url(#clip-path)" xlink:href="../images/cardio2.jpg" width="100%"
					...
					<div class="cover">
						<div class="card">
							...
							<svg width="100%" viewBox="0 0 700 500">
								...
								<!-- xlink:href for modern browsers, src for IE8- -->
								<image clip-path="url(#clip-path)" xlink:href="../images/cardio4.jpg" width="100%"
									   height="465" class="svg__image"></image>
							</svg>
						</div>
					</div>
