				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>The miracle isn’t that I finished. The miracle is that I had the courage to start</h1>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="cover">
						<div class="card">
							...
							<svg width="100%" viewBox="0 0 700 500">
								...
								<!-- xlink:href for modern browsers, src for IE8- -->
								<image clip-path="url(#clip-path)" xlink:href="../images/running5.jpg" width="100%"
									   height="465" class="svg__image"></image>
							</svg>
						</div>
					</div>
